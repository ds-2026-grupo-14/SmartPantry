...
public class SmartPantryModule : AbpModule
{
    ...
    private void ConfigureAutoApiControllers()
    {
        ...
        {
            options.ConventionalControllers.Create(typeof(SmartPantryModule).Assembly);
        });
    }
    ...
    {
        context.Services.AddDataProtection().SetApplicationName("SmartPantry");
    }
    ...
    private void ConfigureVirtualFiles(IWebHostEnvironment hostingEnvironment)
    {
        ...
        {
            options.FileSets.AddEmbedded<SmartPantryModule>();
            if (hostingEnvironment.IsDevelopment())
            {
                /* Using physical files in development, so we don't need to recompile on changes */
                options.FileSets.ReplaceEmbeddedByPhysical<SmartPantryModule>(hostingEnvironment.ContentRootPath);
            }
        });
    }
    ...
    public override void OnApplicationInitialization(ApplicationInitializationContext context)
    {
        ...
        {
            options.SwaggerEndpoint("/swagger/v1/swagger.json", "SmartPantry API");
